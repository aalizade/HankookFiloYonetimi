...
@Component({
  selector: 'app-kategori8x2',
  templateUrl: './kategori8x2.component.html',
  styleUrls: ['./kategori8x2.component.css']
})
export class Kategori8x2Component implements OnInit {
  ...
  aks48ASLD: AracBakimlar[] = []; aks48ASLDName: string = "48-A-SLD"; aks48ASLDId: number;
  aks46ASGD: AracBakimlar[] = []; aks46ASGDName: string = "46-A-SGD"; aks46ASGDId: number;
  aks49ASLI: AracBakimlar[] = []; aks49ASLIName: string = "49-A-SLİ"; aks49ASLIId: number;
  aks47ASGI: AracBakimlar[] = []; aks47ASGIName: string = "47-A-SGİ"; aks47ASGIId: number;
                ...
                if (aracKategoriResponse.Ad !== this.pageName) {
                  ...
                  this.aksPozisyonlarService.getAksPozisyonlar().toPromise().then(aksPozisyonResponse => {
                    ...
                    try {
                      ...
                      this.aks48ASLDId = aksPozisyonResponse.find(a => a.Ad === this.aks48ASLDName).AksPozisyonID;
                      this.aks46ASGDId = aksPozisyonResponse.find(a => a.Ad === this.aks46ASGDName).AksPozisyonID;
                      this.aks49ASLIId = aksPozisyonResponse.find(a => a.Ad === this.aks49ASLIName).AksPozisyonID;
                      this.aks47ASGIId = aksPozisyonResponse.find(a => a.Ad === this.aks47ASGIName).AksPozisyonID;
                      ...
                      this.aracBakimlarService.getAracBakimlarForAracId(response.AracID).subscribe(aracBakimResponse => {
                        ...
                        if (aracBakimResponse.find(a => a.AksPozisyonID === this.aks48ASLDId && a.Aktif === true) === undefined) this.aks48ASLD.push();
                        else this.aks48ASLD.push(aracBakimResponse.find(a => a.AksPozisyonID === this.aks48ASLDId && a.Aktif === true));

                        if (aracBakimResponse.find(a => a.AksPozisyonID === this.aks46ASGDId && a.Aktif === true) === undefined) this.aks46ASGD.push();
                        else this.aks46ASGD.push(aracBakimResponse.find(a => a.AksPozisyonID === this.aks46ASGDId && a.Aktif === true));

                        if (aracBakimResponse.find(a => a.AksPozisyonID === this.aks49ASLIId && a.Aktif === true) === undefined) this.aks49ASLI.push();
                        else this.aks49ASLI.push(aracBakimResponse.find(a => a.AksPozisyonID === this.aks49ASLIId && a.Aktif === true));

                        if (aracBakimResponse.find(a => a.AksPozisyonID === this.aks47ASGIId && a.Aktif === true) === undefined) this.aks47ASGI.push();
                        else this.aks47ASGI.push(aracBakimResponse.find(a => a.AksPozisyonID === this.aks47ASGIId && a.Aktif === true));
  ...
  aracBakimIslemleriKaydet() {
    ...
    form.push(this.aks48ASLD);
    form.push(this.aks46ASGD);
    form.push(this.aks49ASLI);
    form.push(this.aks47ASGI);
  ...
  seriNoKullanildiMiKontrol(seriNo: string) {
    if (this.aks11OSL.find(a => a.SeriNo === seriNo) === undefined
      ...
      && this.aks48ASLD.find(a => a.SeriNo === seriNo) === undefined
      && this.aks46ASGD.find(a => a.SeriNo === seriNo) === undefined
      && this.aks49ASLI.find(a => a.SeriNo === seriNo) === undefined
      && this.aks47ASGI.find(a => a.SeriNo === seriNo) === undefined
  ...
  lastikTipResim(lastikTipId: number) {
    if (lastikTipId === undefined) return "assets/aks-iskeletleri/8x2/img/tire.png"
    var lastikTip = this.lastikTipler.find(a => a.LastikTipID === lastikTipId);
    if (lastikTip !== undefined) {
      if (lastikTip.Ad === "Yeni") return "assets/aks-iskeletleri/8x2/img/yellow_tire.png"
      else if (lastikTip.Ad === "Kaplama") return "assets/aks-iskeletleri/8x2/img/blue_tire.png"
      else if (lastikTip.Ad === "Kullanılmış") return "assets/aks-iskeletleri/8x2/img/green_tire.png"
      else if (lastikTip.Ad === "OE") return "assets/aks-iskeletleri/8x2/img/red_tire.png"
      else return "assets/aks-iskeletleri/8x2/img/tire.png"
    }
    else {
