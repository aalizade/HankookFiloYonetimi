...
@Component({
  selector: 'app-kategori6x2',
  templateUrl: './kategori6x2.component.html',
  styleUrls: ['./kategori6x2.component.css']
})
export class Kategori6x2Component implements OnInit {
  ...
  lastikTipResim(lastikTipId: number) {
    if (lastikTipId === undefined) return "assets/aks-iskeletleri/6x2/img/tire.png"
    var lastikTip = this.lastikTipler.find(a => a.LastikTipID === lastikTipId);
    if (lastikTip !== undefined) {
      if (lastikTip.Ad === "Yeni") return "assets/aks-iskeletleri/6x2/img/yellow_tire.png"
      else if (lastikTip.Ad === "Kaplama") return "assets/aks-iskeletleri/6x2/img/blue_tire.png"
      else if (lastikTip.Ad === "Kullanılmış") return "assets/aks-iskeletleri/6x2/img/green_tire.png"
      else if (lastikTip.Ad === "OE") return "assets/aks-iskeletleri/6x2/img/red_tire.png"
      else return "assets/aks-iskeletleri/6x2/img/tire.png"
    }
    else {
