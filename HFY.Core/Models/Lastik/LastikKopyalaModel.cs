...
{
    public class LastikKopyalaModel : FixedHelperModel
    {
        [Required(ErrorMessage = "Lütfen Asıl Lastik ID belirtiniz.")]
        public int AsilLastikID { get; set; }
        ...
        [Required(ErrorMessage = "Lütfen Kayıt Tarihi giriniz.")]
